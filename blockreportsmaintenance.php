...
$sql = "SELECT reportid,category,problem,residence,block,image, progress FROM maintenanceblockreports";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
// output data of each row
while($row = $result->fetch_assoc()) {
echo "<tr><td>" . $row["reportid"]. "</td><td>" . $row["category"] . "</td><td>". $row["problem"]. "</td><td>" .$row["residence"]."</td><td>" .$row["block"]. "</td><td>".$row["image"]."</td><td>".$row["progress"]. "</td><td>" ;
echo "<div class = 'btn-group'>";
echo "<a class ='btn' href= 'resolved1.php?id=".$row['reportid']."'>resolved</a>";
echo " <a class ='btn' href= 'contractor1.php?id=".$row['reportid']."'>contractor dispatched</a>";
echo "</div>"."</td></td>";
}
echo "</table>";
} else { echo "0 results"; }
...
<div class="sidebar"  >
           ...
           <nav id="sidebar" style="top: 27%">
             ...
             <ul class="list-unstyled components mb-5">
                     ...
                     <li>
                         <a href="maintenance landing.php" onclick= "noback()";>
                             <span>Back</span>
                         </a>
                     </li>
