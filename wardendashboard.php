...
$sql = "SELECT * from studentreports WHERE progress= 'submitted' ";
...
if ($result = mysqli_query($conn, $sql)) {
 ...
 $sql1 = "SELECT * from studentreports WHERE progress= 'approved' ";
...
$sqla = "SELECT * from blockreports WHERE progress= 'submitted' ";
...
if ($result = mysqli_query($conn, $sqla)) {
 ...
 $sqlb = "SELECT * from blockreports WHERE progress= 'approved' ";
