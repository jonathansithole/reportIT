...
$sql = "SELECT reportid,category,problem,residence,block,room,image,studentnumber, progress FROM maintenancestudentreports";
...
echo "<a class ='btn' href= 'resolved.php?id=".$row['reportid']."'>resolved</a>";
echo " <a class ='btn' href= 'contractor.php?id=".$row['reportid']."'>contractor dispatched</a>";
echo "</div>"."</td></td>";
}
echo "</table>";
} else { echo "0 results"; }
