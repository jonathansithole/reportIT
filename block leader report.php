...
nameField.addEventListener("invalid", () => {
  nameField.setCustomValidity("Please fill in the missing  fields.");
        ...
        <div class="form-holder" style="top:90%";>
            <form action="blockreports.php" method="post">
            <h1 class="form-heading">report issues in common areas</h1>
...
<option value=""></option>
  ...
  <option value="toiles" selected>toilets</option>
...
<div class="file-upload">
  ...
  <div class="file-upload-content">
    ...
    <input class = "btn" type="submit" value="Submit"  style= "background-color:rgb(101, 0, 141); color:white; border-radius:5px; width:100%">
              </div>
