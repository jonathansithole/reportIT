...
<body>
    <div class="site-mobile-menu site-navbar-target">
      ...
      <div class="container" style="position: absolute; right:0; top:25%; width:78%">
    				<div class="row">
             <div class="frame">
							<div class="boxes">
								<div class="box box-1">
									<a href="student login.php" class="text">Report issue in your room...</a>
								</div>
								<div class="box box-2">
									<a href="progress tracker.php" class="text">Track report...</a>
								</div>
								<div class="box box-3">
...
<div class= "form-container"style =" top: 100%; width :77%; position: relative; right:0px">
       <div>
    Welcome to ReportIT, a simple platform where all your residence maintenance issues can be resolved in one place. choose your role from the navigation bar on the left in order to access the relevant form, altenatively you can have a chat with our chatbot<br> <br> ReportIT is a system for students and staff members within the Mafikeng Campus to report and track maintenance related issues. Using the system each student within residence has access to  a simple platform which works on any device to report and track any maintenance related issues which need to be addressed within their rooms and the respective block leaders can report maintenance issues with regards to the shared areas. Each reported issue must specify the residence, block, room as well as the information of the occupant of the room. </p>
