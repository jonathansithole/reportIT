...
<div class="site-mobile-menu site-navbar-target">
    ...
    <div class="form-container" style= " top:90%;"!important>
        ...
        <form action="register.php" method="post">
          <h2 class="form-heading">Register New Student</h2>
...
<?php } ?>
         ...
         <input type="text" maxlength= "8" minlength="8" name="studentnumber" id="studentnumber" placeholder="Enter your student number" required><br/>
         <div class="error-message" id="studentnumber-error"></div>
         <div class="error-message" id="password-error"></div>
         <div class="password-requirements">
           <p class="step">Student number requirement</p>
           <ul>
               <li class="req" id ="char-right"><i id="char" class="fa-sharp fa-solid fa-circle-check"></i>must be at least 8 numbers</li>
           </ul>
         </div>
          <p> Contact details</p>
          ...
          <div class="password-requirements">
            ...
            <ul>
                ...
                <li class="req" id ="char-right"><i id="char" class="fa-sharp fa-solid fa-circle-check"></i> must be at least 8 characters</li>
