...
<p>please enter your student number</p>
        ...
        <?php if (isset($_GET['message'])) { ?>
            ...
            <p style="color: purple"class="message"><?php echo $_GET['message']; ?></p>
            
            <?php } ?>

        <button type="submit" class="log-in-button" id="checkprogress"><div class="text-light"></div> <span class="button-text" >track</span></button>
