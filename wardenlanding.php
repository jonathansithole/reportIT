...
<div class="site-mobile-menu site-navbar-target">
      ...
      <div class="container" style="position: absolute; right:0; top:25%; width:78%; height:800px" >
             ...
             <div class="frame">
							<div class="boxes">
								<div class="box box-1" style="background-image: url('images/student.jpg') ">
									<a href="studentreportswarden.php" class="text">student reports...</a>
								</div>
								<div class="box box-2"  style="background-image: url('images/block.png')">
									<a href="blockreportswarden.php" class="text">block leader reports...</a>
								</div>
								<div class="box box-3"  style="background-image: url('images/dashboard.jpg')">
									<a href="wardendashboard.php" class="text">dashboard</a>
								</div>
...
<div class="sidebar"  >
           ...
           <nav id="sidebar" style="top: 19%">
             ...
             <ul class="list-unstyled components mb-5">
                     ...
                     <li>
                         <a href="register account.php">
                             <span >Register new student</span>
                         </a>
                     </li>
                     <li>
                         <a href="register account blockleader.php">
                             <span >Register new block leader</span>
                         </a>
                     </li>
                     <li>
                     ...
                     <li>
                         <a href="warden login.php" onclick= "noback()";>
                             <span>logout</span>
                         </a>
                     </li>
