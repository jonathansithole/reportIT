             ...
             <div class="frame">
							<div class="boxes">
								<div class="box box-1" style="background-image: url('images/student.jpg') ">
									<a href="studentreportsmaintenance.php" class="text">student reports...</a>
								</div>
								<div class="box box-2"  style="background-image: url('images/block.png')">
									<a href="blockreportsmaintenance.php" class="text">block leader reports...</a>
								</div>
								<div class="box box-3"  style="background-image: url('images/dashboard.jpg')">
									<a href="maintenancedashboard.php" class="text">dashboard</a>
								</div>
...
<div class="sidebar"  >
           ...
           <nav id="sidebar" style="top: 27%">
             ...
             <ul class="list-unstyled components mb-5">
                     ...
                     <li>
                         <a href="maintenancedashboard.php">
                         <span>Dashboard </span>
                         </a>
                     </li>
                     <li>
                         <a href="maintenance login.php" onclick= "noback()";>
                             <span>Logout</span>
                         </a>
                     </li>
