...
$sql = "SELECT reportid,category,problem,residence,block,image,progress FROM blockreports";
...
echo "<a class ='btn' href= 'delete1.php?id=".$row['reportid']."'>delete</a>";
echo " <a class ='btn' href= 'approve1.php?id=".$row['reportid']."'>approve</a>";
echo "</div>"."</td></td>";
}
echo "</table>";
} else { echo "0 results"; }
